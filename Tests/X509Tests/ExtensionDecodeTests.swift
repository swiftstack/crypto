...
class ExtensionDecodeTests: TestCase {
    ...
    func testKeyUsageExtension() throws {
    ...
    func testAuthorityKeyIdentifierExtension() throws {
    ...
    func testAuthorityKeyIdentifier() throws {
    ...
    func testCertificatePoliciesExtension() throws {
        let asn1 = ASN1(
            identifier: .init(
                isConstructed: true,
                class: .universal,
    ...
    func testSubjectAltNames() throws {
        let asn1 = ASN1(
            identifier: .init(
                isConstructed: true,
                class: .universal,
