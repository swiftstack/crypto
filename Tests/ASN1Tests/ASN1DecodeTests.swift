...
class ASN1DecodeTests: TestCase {
    func testUniversalSequence() throws {
    ...
    func testContextSpecificEndOfContent() throws {
    ...
    func testContentBoolean() throws {
    ...
    func testContentEnumerated() throws {
    ...
    func testContentSequence() throws {
        let result = try ASN1(from: [
            0x30, 0x06,
            0x0a, 0x01, 0x00,
            0x0a, 0x01, 0x00
    ...
    func testContentPrintableString() throws {
        let result = try ASN1(from: [
            0x13, 0x02, 0x52, 0x55
        ])
        expect(result.identifier == .init(
    ...
    func testContentUTF8String() throws {
        let result = try ASN1(from: [
            0x0c, 0x19,
    ...
    func testContentObjectIdentifier() throws {
        let result = try ASN1(from: [
                0x06, 0x09,
